...
project = u'Wallace'
copyright = u'2016, CoCoSci lab at UC Berkeley'
author = u'CoCoSci lab at UC Berkeley'
...
latex_documents = [
    (master_doc, 'Wallace.tex', u'Wallace Documentation',
     u'CoCoSci lab at UC Berkeley', 'manual'),
]
...
github_doc_root = 'https://github.com/suchow/Wallace/tree/master/docs/'
